...
if(isset($_POST['name']) /*&& isset($_POST['priv'])*/){
   ...
   // $date = htmlentities(mysqli_real_escape_string($link, $_POST['date']));
    ...
    @$foto1 = htmlentities(mysqli_real_escape_string($link, $_POST['foto1']));
    @$foto2 = htmlentities(mysqli_real_escape_string($link, $_POST['foto2']));
    @$foto3 = htmlentities(mysqli_real_escape_string($link, $_POST['foto3']));
...
else {$json['file1geo']= "Нет геотегов в фото $gps . ";}
